...
var UploadDir string = filepath.Join(PresentDir, "mahabira-logistics-document", "ride", FileSeparator)
var TempPath = filepath.Join(PresentDir, "mahabira-tempdocument", "doc")
